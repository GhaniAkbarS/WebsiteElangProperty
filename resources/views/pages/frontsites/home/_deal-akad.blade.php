                        ...
                        <div class="news-one__single">
                            ...
                            <div class="news-one__content">
                                <div class="news-one__content-top">
                                    <p class="news-one__sub-title">Cabang {{ $deal->branch->title }}</p>
                                    <h3 class="news-one__title">
                                        <a href="{{ route('deals.detail', $deal->id) }}"
                                            style="color: inherit; text-decoration: none;">{{ $deal->title }}</a>
                                    </h3>
                                </div>
                                <div class="news-one__person-and-date">
                                    <div class="news-one__date">
                                        <p><span
                                                class="icon-icon-calendar"></span>{{ $deal->created_at->format('M d, Y') }}
                                        </p>
                                    </div>
                                </div>
                            </div>
