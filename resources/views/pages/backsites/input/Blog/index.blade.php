...
<x-back-app-layout>
    ...
    <div class="page-wrapper">
        ...
        <div class="page-header d-print-none">
            <div class="container-xl">
                <div class="row g-2 align-items-center">
                    <div class="col">
                        <!-- Page pre-title -->
                        <div class="page-pretitle">Daftar</div>
                                                            ...
                                                            <li>
                                                                <form action="{{ route('blog.destroy', $blog->id) }}"
                                                                    ...
                                                                    <button class="dropdown-item" type="button"
                                                                        onclick="handleAction('delete', {{ $blog->id }})">Delete</button>
                                                                </form>
                                                            </li>
                                                        </ul>
                                                    </div>
        ...
        <!-- Modal Edit Blog -->
        @foreach ($blogs as $blog)
            <div class="modal fade" id="editBlogModal{{ $blog->id }}" tabindex="-1" role="dialog"
                        ...
                        <form method="POST" action="{{ route('blog.update', $blog->id) }}">
                            ...
                            <div class="modal-body">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="modal-title-{{ $blog->id }}" name="title"
                                        class="form-control" value="{{ $blog->title }}" required>
                                </div>
                                <div class="form-group">
                                    <label for="modal-category-{{ $blog->id }}">Kategori</label>
                                    <select name="category_id" id="modal-category-{{ $blog->id }}"
                                        class="form-control">
